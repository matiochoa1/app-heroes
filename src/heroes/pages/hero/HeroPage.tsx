...
import { HeroHeaderView } from "@/heroes/components/HeroHeaderView";
...
export const HeroPage = () => {
  ...
  const { data: superheroData, isError } = useHeroInformation(idSlug);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header Banner */}
      <HeroHeaderView averagePower={averagePower} hero={superheroData} />
