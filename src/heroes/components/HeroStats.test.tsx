...
const mockHeroSummaryResponse: SummaryInformationResponse = {
  totalHeroes: 25,
  strongestHero: {
    id: "1",
    name: "Clark Kent",
...
describe("HeroStats", () => {
  ...
  test("should render HeroStats with mock information", () => {
    const { container } = renderHeroStats(mockHeroSummaryResponse);
  ...
  test("should change the percentage of favorites when a hero is added", () => {
    localStorage.setItem("favorites", JSON.stringify([mockHero]));

    renderHeroStats(mockHeroSummaryResponse);
